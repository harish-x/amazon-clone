...
const Register = () => {
    ...
    e.preventDefault()
        ...
        dispatch(RegisterUser({ name, email, password, avatar})).then(unwrapResult).then((result) => {
    ...
    <>
      <div className="h-[100dvh] w-[100dvw] flex items-center justify-center">
        ...
        >
                  ...
                  <img className='rounded-full w-16 mt-3 cursor-pointer h-16' src={prevAvatar} alt=""/>
          <input
            type="text"
            placeholder="Name"
